...
namespace SisRem.Api.Controllers.Base
{
    public class ControllerBase : ApiController
    {
        ...
        public async Task<HttpResponseMessage> ResponseExceptionAsync(Exception ex, ExceptionRequest request)
        {

            request.DescricaoErro = ex.Message.ToString();
            request.StackTrace = ex.StackTrace.ToString().Replace("//", "-").Replace(":", "-");
